...
public abstract class BaseTCPServer implements Runnable {
	...
	public BaseTCPServer(int port, Executor executor) {
		this.port = port;
		this.executor = executor;
	}
	
	public BaseTCPServer(int port, Executor executor, String charset) {
		this.port = port;
		this.executor = executor;
		this.charset = charset;
	}
